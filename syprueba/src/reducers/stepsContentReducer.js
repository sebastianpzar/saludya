...
const contentArray = 
[
    {id: 0, step: 1, title: "Elije tu plan.", btnText: "VER LOS PLANES", btnPath: "/signup/plans", body: <div><i className="fas fa-check" /><p>No commitments, cancel anytime.</p><i className="fas fa-check" /><p>Everything on Netflix for one low price.</p><i className="fas fa-check" /><p>Unlimited viewing on all your devices.</p></div>},
